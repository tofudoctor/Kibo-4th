...
//        show_point_log(p);
//        Log.i(TAG, "arrive T4");
//        api.relativeMoveTo(new Point(0, 0.01, 0), q, true);
//        api.laserControl(true);
//        api.flashlightControlFront(0.05f);
//
//        // take active target snapshots
...
//        // T6 = P5 + Q0 (opposite)
//        p = P[5 + 7];
//        q = quaternion[0];// new Quaternion(1,0,0,0);
//
//
//        api.moveTo(p, q, true);
//        show_point_log(p);
...
//        api.relativeMoveTo(new Point(0, -0.2, 0.1), q, true);
//
...
//
//
//        p = new Point(p.getX(), p.getY(), posZ[2]);
//        api.moveTo(p, q, true);
//        show_point_log(p);
//        Log.i(TAG, "arrive T3");
//        api.laserControl(true);
